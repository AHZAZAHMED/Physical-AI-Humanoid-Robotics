# Quickstart Guide: Agent-based RAG Reasoning Flow
...
1. Review the complete API documentation in [contracts/api-contracts.yaml](./contracts/api-contracts.yaml)
2. Examine the data model in [data-model.md](./data-model.md) for detailed entity definitions
3. Explore the research findings in [research.md](./research.md) for architectural decisions
4. Run the complete test suite to verify your setup